...
function emailFormSubmission()
{
	...
	$to = 'bespokenails@gmail.com';
	$subject = 'Formularz CONTACT US Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>name:</b></td><td>' . htmlentities($_REQUEST["custom_U1363"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>message:</b></td><td>' . htmlentities($_REQUEST["custom_U1358"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$headers = 'From: bespokenails@gmail.com' . PHP_EOL . 'Reply-To: ' . $formEmail . PHP_EOL .'X-Mailer: Adobe Muse 2014.0.30 with PHP/' . phpversion() .'/'. PHP_OS . PHP_EOL . 'Content-type: text/html; charset=utf-8' . PHP_EOL;
