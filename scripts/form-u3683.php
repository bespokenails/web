...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>name:</b></td><td>' . htmlentities($_REQUEST["custom_U3685"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>message:</b></td><td>' . htmlentities($_REQUEST["custom_U3690"],ENT_COMPAT,'UTF-8') . '</td></tr>';
